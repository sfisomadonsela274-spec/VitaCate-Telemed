...
<CommonElevationBehavior>
    canvas.before:
        ...
        BoxShadow:
            ...
            border_radius: root.md_border_radius()
    canvas.after:
        PopMatrix
"""
)

def _get_normalized_radius(self):
    r = self.shadow_radius if self.shadow_radius != [0.0, 0.0, 0.0, 0.0] and self.shadow_radius else getattr(self, "radius", [0,0,0,0])
    if r is None:
        r = [0,0,0,0]
...
CommonElevationBehavior.md_border_radius = _get_normalized_radius
)
